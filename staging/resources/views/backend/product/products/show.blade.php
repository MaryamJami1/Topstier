        ...
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-lg-auto">
                    ...
                    @if ($product->video)
                        <video src="{{ uploaded_asset($product->video) }}" controls class="img-fluid mt-10 size-200px "></video>
                    @endif
                </div>
                <div class="col-lg">
                    ...
                    <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="5" data-xl-items="5"
                        ...
                        @if ($product->video)
                            <div class="carousel-box">
                                <video src="{{ uploaded_asset($product->video) }}" controls class="img-fluid" autoplay></video>
                            </div>
                        @endif
