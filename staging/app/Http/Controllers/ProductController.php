...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->has('video')) {
            $request->validate([
                'video' => 'nullable|mimes:mp4,mov,avi,wmv,flv,webm,mkv|max:51200' // Max 50MB
            ], [
                'video.mimes' => translate('The video must be a file of type: mp4, mov, avi, wmv, flv, webm, mkv.'),
                'video.max' => translate('The video may not be greater than 50MB.')
            ]);
        }
