                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label"
                                for="signinSrEmail">{{ translate('Gallery Images') }}<small>(1:1 ratio)</small></label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{ translate('Product Video') }} <small>{{ translate('optional') }}</small></label>
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="video">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="video" class="selected-files" value="{{ $product->video }}">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                                <small class="text-muted">{{ translate('Upload a product video (mp4, webm, avi, mov, etc).') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
