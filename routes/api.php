...
Route::group(['prefix' => 'v1', 'as' => 'api.'], function () {
    ...
    Route::prefix('ups')->group(function () {
        Route::post('/rates', [UpsController::class, 'getRates']);
        Route::get('/simple-rates', [UpsController::class, 'getSimpleRates']);
        Route::post('/ship', [UpsController::class, 'createShipment']);
        Route::get('/track/{trackingNumber}', [UpsController::class, 'trackShipment']);
        Route::post('/track-multiple', [UpsController::class, 'trackMultiple']);
        Route::post('/void', [UpsController::class, 'voidShipment']);
        Route::get('/token-info', [UpsController::class, 'getTokenInfo']);
        Route::get('/services', [UpsController::class, 'getServices']);
    });
});
